                ...
                <div id="loginForm">
                    <form v-on:submit.prevent="login" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="input-pass" name="password" v-model="trainerVo.password"
    ...
    methods: {
        ...
        login() {
            ...
            axios({
                ...
                url: 'http://localhost:8889/api/trainer/login',
